...
class GetDienststellenLeistungsbeschreibungenTest extends BaseEndpointTest
{
    ...
    public function testGetDienststellenLeistungsbeschreibungen(GetDienststellenLeistungsbeschreibungenRequest $request): void
    {
    ...
    {
        yield [new GetDienststellenLeistungsbeschreibungenRequest(
