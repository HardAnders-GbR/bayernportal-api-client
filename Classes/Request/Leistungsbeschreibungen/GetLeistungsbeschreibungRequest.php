...
{
    /**
     * @param string|null $gemeindekennziffer        8-stelliger Amtlicher Gemeindeschlüssel eines Ortes in Bayern, für den der Response lokalisiert werden soll (z.B. 09162000 für München).
